...
<title>Medium vs. Substack | The Applegate News</title>
<meta name="description" content="In the quiet weeks since leaving campus behind, I&#39;ve found myself in that strange liminal space familiar to anyone who&#39;s completed a significant chapter of their life. The graduation gown remains unworn, commencement still weeks away, my apartment half-packed with cardboard boxes bearing cryptic labels.">
<meta name="author" content="Edward C. Johnson">
...
<!-- Open Graph -->
<meta property="og:title" content="Medium vs. Substack">
<meta property="og:description" content="In the quiet weeks since leaving campus behind, I&#39;ve found myself in that strange liminal space familiar to anyone who&#39;s completed a significant chapter of their life. The graduation gown remains unworn, commencement still weeks away, my apartment half-packed with cardboard boxes bearing cryptic labels.">
<meta property="og:type" content="article">
<meta property="og:url" content="https://newspaper.paulapplegate.com/articles/Medium-vs--Substack/">
<meta property="og:image" content="https://newspaper.paulapplegate.comhttps://cdn-images-1.medium.com/max/800/0*hORw6ne73jDnhmtB">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="675">

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Medium vs. Substack">
<meta name="twitter:description" content="In the quiet weeks since leaving campus behind, I&#39;ve found myself in that strange liminal space familiar to anyone who&#39;s completed a significant chapter of their life. The graduation gown remains unworn, commencement still weeks away, my apartment half-packed with cardboard boxes bearing cryptic labels.">
<meta name="twitter:image" content="https://newspaper.paulapplegate.comhttps://cdn-images-1.medium.com/max/800/0*hORw6ne73jDnhmtB">

<!-- RSS -->
<link rel="alternate" type="application/atom+xml" title="The Applegate News" href="https://newspaper.paulapplegate.com/feed.xml">

<!-- Fonts -->
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Newsreader:ital,opsz,wght@0,6..72,200..800;1,6..72,200..800&family=Merriweather:ital,wght@0,300;0,400;0,700;1,400&family=Source+Sans+3:wght@400;600&display=swap" rel="stylesheet">

<!-- Styles -->
<link rel="stylesheet" href="/css/newspaper.css">
<link rel="stylesheet" href="/css/print.css" media="print">

  <script src="https://kit.fontawesome.com/f081a8d678.js" crossorigin="anonymous"></script>
</head>
<body>
  <a href="#main-content" class="skip-link">Skip to content</a>
  <div class="masthead">
  <div class="masthead__top">
    <div class="masthead__weather">
      <span class="masthead__established">Est. 2026</span>
    </div>
    <div class="masthead__title-wrap">
      <a href="/" class="masthead__title">The Applegate News</a>
    </div>
    <div class="masthead__meta">
      <a href="/feed.xml" class="masthead__rss" aria-label="RSS Feed">&#9741; RSS</a>
    </div>
  </div>
  <div class="masthead__tagline">No AI. Well, maybe some, but I will mention it upfront!</div>
  <div class="masthead__date" id="current-date"></div>
  <nav class="masthead__nav" aria-label="Main navigation">
    <ul class="masthead__nav-list">
      
      <li class="masthead__nav-item">
        <a href="/category/news/" class="masthead__nav-link">News</a>
      </li>
      
      <li class="masthead__nav-item">
        <a href="/category/opinion/" class="masthead__nav-link">Opinion</a>
      </li>
      
      <li class="masthead__nav-item">
        <a href="/category/features/" class="masthead__nav-link">Features</a>
      </li>
      
      <li class="masthead__nav-item">
        <a href="/category/culture/" class="masthead__nav-link">Culture</a>
      </li>
      
      <li class="masthead__nav-item">
        <a href="/category/business/" class="masthead__nav-link">Business</a>
      </li>
      
      <li class="masthead__nav-item">
        <a href="/archive/" class="masthead__nav-link">Archive</a>
      </li>
      
      <li class="masthead__nav-item">
        <a href="/about/" class="masthead__nav-link">About</a>
      </li>
  ...
  <header class="article-page__header">
    ...
    <a href="/category/business/" class="article-page__category">Business</a>
    
    <h1 class="article-page__title" itemprop="headline">Medium vs. Substack</h1>
    
    <p class="article-page__subtitle" itemprop="alternativeHeadline">My experience writing on Medium for the past 10 years</p>
    
    <div class="article-page__meta">
      
      <span class="article-page__author" itemprop="author">By <strong>Edward C. Johnson</strong></span>
      
      <time class="article-page__date" datetime="2025-05-06T00:00:00.000Z" itemprop="datePublished">Monday, May 5, 2025</time>
      <span class="article-page__readtime">10 min read</span>
    </div>
  </header>

  
  <figure class="article-page__hero">
    <img src="https://cdn-images-1.medium.com/max/800/0*hORw6ne73jDnhmtB" alt="Photo by Yannik Mika on Unsplash*" class="article-page__hero-image" itemprop="image" loading="eager">
    
    <figcaption class="article-page__hero-caption">Photo by Yannik Mika on Unsplash*</figcaption>
    
  </figure>
  

  <div class="article-page__body" itemprop="articleBody">
    <p>In the quiet weeks since leaving campus behind, I’ve found myself in that strange liminal space familiar to anyone who’s completed a significant chapter of their life. The graduation gown remains unworn, commencement still weeks away, my apartment half-packed with cardboard boxes bearing cryptic labels. <em>Books—Poetry. Textbooks—Theory. Notebooks—Write Club.</em> Physical artifacts of four years distilled into categorized containers. What remains when you strip away student identity, leadership roles, and familiar routines? I find myself constantly taking inventory, counting what I’ve accumulated beyond the diploma that will arrive in the mail.</p>
...
<picture>
  ...
  <footer class="article-page__footer">
    <div class="article-page__rule"></div>

    
    <div class="article-page__author-bio">
      <p class="article-page__author-bio-name">Edward C. Johnson</p>
      <p class="article-page__author-bio-text">The Applegate News contributor</p>
    </div>
    

    <div class="article-page__share">
      <span class="article-page__share-label">Share this article:</span>
      <a href="https://mastodon.social/?status=Medium vs. Substack https://newspaper.paulapplegate.com/articles/Medium-vs--Substack/" target="_blank" rel="noopener" aria-label="Share on Mastodon">Mastodon</a>
      <a href="https://bsky.app/intent/compose?text=Medium vs. Substack https://newspaper.paulapplegate.com/articles/Medium-vs--Substack/" target="_blank" rel="noopener" aria-label="Share on Bluesky">Bluesky</a>
      <a href="https://www.threads.net/intent/post?text=Medium vs. Substack https://newspaper.paulapplegate.com/articles/Medium-vs--Substack/" target="_blank" rel="noopener" aria-label="Share on Threads">Threads</a>
      <a href="mailto:?subject=Medium vs. Substack&body=https://newspaper.paulapplegate.com/articles/Medium-vs--Substack/" aria-label="Share via email">Email</a>
    </div>

    
    
    <div class="article-page__related">
      <h3 class="article-page__related-heading">Related Articles</h3>
      <ul class="article-page__related-list">
        
        
        <li>
          <a href="/articles/10-Ways-to-Write-Like-the-90-s/">10 Ways to Write Like the 90’s</a>
          <time datetime="2025-12-07T00:00:00.000Z">Dec 6, 2025</time>
        </li>
        
        
        
        <li>
          <a href="/articles/What-does-it-mean-to-be-a-good-editor-/">What does it mean to be a good editor?</a>
          <time datetime="2025-12-06T00:00:00.000Z">Dec 5, 2025</time>
        </li>
        
        
        
        <li>
          <a href="/articles/Move-to-a-Better-Internet-in-2026-/">Move to a Better Internet in 2026.</a>
          <time datetime="2025-12-03T00:00:00.000Z">Dec 2, 2025</time>
        </li>
    ...
    <div class="article-page__newsletter">
      <h3 class="article-page__newsletter-heading">Enjoy this article?</h3>
      <p>Subscribe to get every edition of The Applegate News delivered to your inbox.</p>
      <form class="newsletter-signup__form" action="#" method="post">
        <input type="email" class="newsletter-signup__input" placeholder="your@email.com" aria-label="Email address" required>
  ...
  <div class="site-footer__content">
    ...
    <div class="site-footer__col">
      <h4 class="site-footer__heading">Subscribe</h4>
      <p class="site-footer__text">Get the latest delivered to your inbox.</p>
      ...
      <p class="site-footer__text site-footer__rss">
        <a href="/feed.xml">&#9741; RSS Feed</a>
      </p>
    </div>
  </div>
  <div class="site-footer__bottom">
    <p>&copy; 2026 Code is <a href="https://github.com/brennanbrown/newsprint/blob/main/LICENSE">MIT</a> and content is <a href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA</a> | <a href="https://github.com/brennanbrown/newsprint">Newsprint Theme</a> by <a href="https://berryhouse.ca">Berry House</a> | Built with <a href="https://www.11ty.dev/">11ty</a> | <a href="https://newspaper.paulapplegate.com/files/Paul_Applegate_0x9ACA97B0B53499ABD166DAA73F6F153428317F5F_pub.asc"><i class="fa-solid fa-fingerprint"></i> 9ACA97B0B53499ABD166DAA73F6F153428317F5F</a></p>
  </div>
</footer>

  <script>
  // Newspaper date display
  (function() {
